...
public class CodeGenerationController extends BaseController {    
    ...
    public void usingFileAsStringAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5157553853944727384L;
            {
                    put( "name", name );
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4878401567478116814L;
            {
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4678882558492843137L;
            {
                    put( "body", body );
            }
        };
    ...
    public void usingUrlAsStringAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5570556936193647228L;
            {
                    put( "template", (template != null) ? template.value() : null );
                    put( "format", (format != null) ? format.value() : null );
                    put( "name", name );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5676570911427805104L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void usingFileAsBinaryAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5639016497553716209L;
            {
                    put( "name", name );
                    put( "format", (format != null) ? format.value() : null );
                    put( "template", (template != null) ? template.value() : null );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5596783070128509838L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5584140083893555484L;
            {
                    put( "body", body );
            }
        };
    ...
    public void usingUrlAsBinaryAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5281378648914065514L;
            {
                    put( "template", (template != null) ? template.value() : null );
                    put( "format", (format != null) ? format.value() : null );
                    put( "name", name );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5512430810866511660L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void usingApikeyAsBinaryAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5193937592514026348L;
            {
                    put( "apikey", apikey );
                    put( "template", (template != null) ? template.value() : null );
                    put( "dl", (dl != null) ? dl : 1 );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4988089667180562436L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void usingApikeyAsStringAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4625980838618183035L;
            {
                    put( "apikey", apikey );
                    put( "template", (template != null) ? template.value() : null );
                    put( "dl", (dl != null) ? dl : 0 );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5569333650894434857L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
