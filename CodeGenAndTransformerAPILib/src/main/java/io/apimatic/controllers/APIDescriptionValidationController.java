...
public class APIDescriptionValidationController extends BaseController {    
    ...
    public void usingFileAsync(
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4842729026712504339L;
            {
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5252370243866315899L;
            {
                    put( "body", body );
            }
        };
    ...
    public void usingUrlAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4913778531710286667L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5441973655730971197L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
            }
    ...
    public void usingApikeyAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5730408750353116627L;
            {
                    put( "apikey", apikey );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5031673283853450262L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
            }
